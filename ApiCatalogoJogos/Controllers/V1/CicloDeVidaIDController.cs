...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    {
        //Quando a aplicação sobe, ele gera um instância Singleton do recurso que
        //permanece estática até a aplicação ser finalizada para todas as requisições.
        public readonly IExemploSingleton _exemploSingleton1;
        public readonly IExemploSingleton _exemploSingleton2;

        //A cada requisição gera uma instância Scoped que perdura durante toda aquela requisição
        public readonly IExemploScoped _exemploScoped1;
        public readonly IExemploScoped _exemploScoped2;

        //Para cada vez que é injetado ele te da uma instância nova Transient para a requisição
